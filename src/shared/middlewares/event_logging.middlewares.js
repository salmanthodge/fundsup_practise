...
const responseOnFinish = async (...params) => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
        sharedServices.loggerServices.info(
            "Request:" + req.requestId + "Request Body: " + JSON.stringify(req.body) + "Response Code:" + res.statusCode + "Response: " + JSON.stringify(res.statusMessage)
        );
    }
    if (res.statusCode >= 400 && res.statusCode < 500) {

        sharedServices.loggerServices.error(
            "Request:" + req.requestId + "Request Body: " + JSON.stringify(req.body) + "Response Code:" + res.statusCode + "Response: " + res.statusMessage
        );
    }
